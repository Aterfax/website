...
ActiveRecord::Schema.define(version: 2018_12_15_134405) do
  ...
  create_table "society_servers", force: :cascade do |t|
    t.integer "game_id"
    t.integer "port"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["game_id"], name: "index_society_servers_on_game_id"
  end
